...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $subject = "DRM Roofing Glass and Aluminum And Iron Works";
...
?>
   ...
   <p style="color: #ffcc00; font-size: 28px; font-weight: bold; margin-left:-40px;">DRM: ONLINE ORDERING SYSTEM</p>
</header>
